<div>
    ...
    <div>
        ...
        <p>
            ...
            starter -- team morning meetings negotiated to as close as
            possible to lunch time -- something about beauty rest.  A flair
            for styling with a penchant for minimalistic php and javaScript
            functions that call other minimalistic functions to get the job
            done.  Quiet, steady, easy going team mate.
        </p>
    </div>
    <div>
        <p>Mark O'Donnell</p>
        ...
        <p>
            ...
            Crazy Irish?  Coach, educator, facilitator, thinker
            Need to see recursive code in action?
            Want to see minimalistic PHP coding style?
            Looking for obscure PHP commands to do a job perfectly?
            Yup Crazy is right!  No idea about the Irish part.
            The strong, silent type - almost apologetic about helping his team mates
            reach professional understandings of php /  javascript / mysql and server
            management.  On top of all that flattery, he enjoys a good beer! Ooops
            wrong O'Donnell on the picture.
        </p>
    </div>
    <div>
        <p>James Bergeron</p>
        ...
        <p>
            ...
            All in all, one can say with confidence that James is the oldest in the
            group, class, and program.  Betting money is he won't graduate, but will
            make Nolan get up earlier!
        </p>
    </div>
</div>