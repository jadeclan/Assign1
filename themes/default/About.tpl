            ...
            <div class="card">
                <div class="card-panel hoverable">
                    <div class="card-image">
                        ...
                        <span id="cardTitle" class="card-title">Sonia Pitrola</span>
                    </div>
            ...
            <div class="card">
                <div class="card-panel hoverable">
                    <div class="card-image">
                        ...
                        <span id="cardTitle" class="card-title">Nolan Walker</span>
                    </div>
                    <div class="card-content">
                        <p>
            ...
            <div class="card">
                <div class="card-panel hoverable">
                    <div class="card-image">
                        ...
                        <span id="cardTitle" class="card-title">James Bergeron</span>
                    </div>
                    <div class="card-content">
                        <p>
